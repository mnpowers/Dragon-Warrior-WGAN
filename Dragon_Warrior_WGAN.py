...
def train_models( epochs, gen_rate, disc_rate, prev_epochs, batch_size, noise_dim, 
    ...
    for epoch in range(epochs):
        ...
        for i in range(len(minibatches)):
            ...
            sample_size = real_images.shape[0]
            ...
            if (i%n_critic) != 0:
                with tf.GradientTape() as disc_tape: 
                    ...
                    fake_images = gen_model(noise, training=False)
                    ...
                    #convert list of gradient components to tensor
                ...
                with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
                    ...
                    fake_images = gen_model(noise, training=True)
                    fake_output = disc_model(fake_images, training=True)
